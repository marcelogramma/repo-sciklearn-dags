...
def extract_load_data():
    ...
    insert = con.execute(
        ...
        (
            raw_df.loc["fl_date"],
            raw_df.loc["op_carrier"],
            raw_df.loc["op_carrier_fl_num"],
            raw_df.loc["origin"],
            raw_df.loc["dest"],
            raw_df.loc["crs_dep_time"],
            raw_df.loc["dep_time"],
            raw_df.loc["dep_delay"],
            raw_df.loc["taxi_out"],
            raw_df.loc["wheels_off"],
            raw_df.loc["wheels_on"],
            raw_df.loc["taxi_in"],
            raw_df.loc["crs_air_time"],
            raw_df.loc["arr_time"],
            raw_df.loc["arr_delay"],
            raw_df.loc["cancelled"],
            raw_df.loc["cancellation_code"],
            raw_df.loc["diverted"],
            raw_df.loc["crs_elapsed_time"],
            raw_df.loc["actual_elapsed_time"],
            raw_df.loc["air_time"],
            raw_df.loc["distance"],
            raw_df.loc["carrier_delay"],
            raw_df.loc["wheater_delay"],
            raw_df.loc["nas_delay"],
            raw_df.loc["security_delay"],
            raw_df.loc["late_aircraft_delay"],
            raw_df.loc["unnamed"],
        ),
