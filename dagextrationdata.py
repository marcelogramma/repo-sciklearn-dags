...
def extract_load_data():
    ...
    insert = con.execute(
        ...
        """,
        (
            raw_df.loc["fl_date"][1],
            raw_df.loc["op_carrier"][2],
            raw_df.loc["op_carrier_fl_num"][3],
            raw_df.loc["origin"][4],
            raw_df.loc["dest"][5],
            raw_df.loc["crs_dep_time"][6],
            raw_df.loc["dep_time"][7],
            raw_df.loc["dep_delay"][8],
            raw_df.loc["taxi_out"][9],
            raw_df.loc["wheels_off"][10],
            raw_df.loc["wheels_on"][11],
            raw_df.loc["taxi_in"][12],
            raw_df.loc["crs_air_time"][13],
            raw_df.loc["arr_time"][14],
            raw_df.loc["arr_delay"][15],
            raw_df.loc["cancelled"][16],
            raw_df.loc["cancellation_code"][17],
            raw_df.loc["diverted"][18],
            raw_df.loc["crs_elapsed_time"][19],
            raw_df.loc["actual_elapsed_time"][20],
            raw_df.loc["air_time"][21],
            raw_df.loc["distance"][22],
            raw_df.loc["carrier_delay"][23],
            raw_df.loc["wheater_delay"][24],
            raw_df.loc["nas_delay"][25],
            raw_df.loc["security_delay"][26],
            raw_df.loc["late_aircraft_delay"][27],
            raw_df.loc["unnamed"][28],
        ),
